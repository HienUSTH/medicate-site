...
function applyLoggedOutUI() {
  ...
  setText('#desktopAccountName', 'Chưa đăng nhập');
  setText('#desktopAccountEmail', '—');
  setText('#desktopAccountCreatedAt', '—');

  setText('#mobileAccountName', 'Chưa đăng nhập');
  setText('#mobileAccountEmail', '—');
  setText('#mobileAccountCreatedAt', '—');
...
function applyLoggedInUI(profile, session) {
  ...
  setText('#desktopAccountName', displayName);
  setText('#desktopAccountEmail', email);
  setText('#desktopAccountCreatedAt', createdAt);

  setText('#mobileAccountName', displayName);
  setText('#mobileAccountEmail', email);
  setText('#mobileAccountCreatedAt', createdAt);
