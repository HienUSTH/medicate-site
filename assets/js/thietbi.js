...
(function(){
  ...
  const DEF = [
    ...
    { id:"nguon-pin", name:"Nguồn / Pin / Sạc", desc:"Cung cấp năng lượng cho hệ thống.", items:[
      { name:"4 Pin sạc AA 2200 mWh", specs:["Chuẩn AA, dung lượng ~2200 mWh","Có thể sạc lại"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } },
      { name:"Pin sạc 3.7V 18650", specs:["Dung lượng 2000–3500 mAh","Dòng xả cao, tái sạc"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } },
      { name:"Đế pin 18650", specs:["Khay 1–2 cell 18650","Dây cắm/đầu cos tuỳ loại"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } },
      { name:"Bộ sạc tự ngắt 18650", specs:["Tự ngắt khi đầy, bảo vệ quá sạc","Nguồn vào 5V USB"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } }
    ]},
    { id:"giam-ap", name:"Module giảm áp", desc:"Buck converter hạ áp từ nguồn cao xuống mức dùng được.", items:[
      { name:"MP1584 (5V→3.3V)", specs:["Dòng tối đa ~3A","Hiệu suất cao, kích thước nhỏ"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } },
      { name:"LM2596S 3A (hạ xuống 5V)", specs:["Dòng tối đa 3A","Có biến trở chỉnh áp"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } }
    ]},
    { id:"phu-kien", name:"Phụ kiện", desc:"Dây nối, breadboard và linh kiện phụ trợ.", items:[
      { name:"Dây nối đực-đực 21 cm", specs:["Jumper male-male","Chiều dài ~21 cm"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } },
      { name:"Breadboard 830 lỗ", specs:["Tiêu chuẩn 830 tie-points","Tương thích jumper 22–26AWG"], img:"", url:"", vendorBase:{ name:"(thêm link sau)", url:"" } }
    ]}
  ];
